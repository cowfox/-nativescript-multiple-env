 ...
 * For example:
 * - `en.default.staging.json` will be renamed to `en.default.json`
 * - `file.staging` will be renamed to `file`
 *
 */
function buildDestinationFileName(logger, file, regex) {
    /*
        The new way to help cover the case that the file does not have
        the `ext`.
        In this way,
        - The `regex` defines `3` groups - {before_env}, {env}, {after_env}(ext)

        NOTES:
        - If it cannot match the "new" way, fallback to the "old" way still.
     */
